    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 SpriteFrag(v2f IN) : SV_Target
            {
                ...
                float3 textureTex = tex2D(_TextureTex, (IN.texcoord)*_Data.z+float2(sin(IN.color.a*6.28),cos(IN.color.a*6.28))).xyz;
                ...
                float3 texx = lerp(float3(1,1,1),textureTex,saturate((1-albedo.b)+_Data.x))*_Data.y;
